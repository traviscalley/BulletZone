...
import tgc1002.gridsim.Model.GridCell;
import tgc1002.gridsim.Model.GridCellFactory;
 ...
 */
public class SimGridFacade implements SimGridSubscriber
{
    // class variables
     ...
     */
    public SimGridFacade(Context context, Activity activity)
    {
        ...
        if (context != null && activity != null)
        {
            ...
            iAdapter = new ImageAdapter(context);
